...
export const featureImports: Record<FeatureKey, () => Promise<unknown>> = {
  ...
  fleetTrackingTags:   () => import('@/features/fleet'),
  fleetTrackingScans:  () => import('@/features/fleet'),
  assetsIssues:     () => import('@/features/issues'),
  assetsTrackingMap:    () => import('@/features/assets'),
  assetsTrackingTags:   () => import('@/features/assets'),
  assetsTrackingScans:  () => import('@/features/assets'),
  tracking:         () => import('@/features/tracking'),
  trackingGps:      () => import('@/features/tracking'),
  trackingTags:     () => import('@/features/tracking'),
  trackingScans:    () => import('@/features/tracking'),
