...
export const mockStockMovements: StockMovement[] = [
  { id: 'MV-2001', itemId: 'INV-1001', type: 'in',         quantity: 100, destinationLocationId: 'W001',                              reason: 'PO-2025-0019 received',          createdAt: '2026-04-26T09:12:00Z', createdBy: 'Admin User' },
  { id: 'MV-2002', itemId: 'INV-1002', type: 'out',        quantity: 12,  sourceLocationId: 'W001',                                    reason: 'Issued to Operations dept.',     createdAt: '2026-04-26T11:30:00Z', createdBy: 'Jane Doe' },
  { id: 'MV-2003', itemId: 'INV-1006', type: 'transfer',   quantity: 50,  sourceLocationId: 'W001', destinationLocationId: 'W002',     reason: 'Restocking north DC',            createdAt: '2026-04-26T14:08:00Z', createdBy: 'Jane Doe' },
  { id: 'MV-2004', itemId: 'INV-1005', type: 'in',         quantity: 30,  destinationLocationId: 'W002',                              reason: 'PO-2025-0020 received',          createdAt: '2026-04-27T08:01:00Z', createdBy: 'Admin User' },
  { id: 'MV-2005', itemId: 'INV-1009', type: 'out',        quantity: 6,   sourceLocationId: 'W001',                                    reason: 'Site team Alpha — daily issue', createdAt: '2026-04-27T08:42:00Z', createdBy: 'John Smith' },
  { id: 'MV-2006', itemId: 'INV-1003', type: 'adjustment', quantity: -1,  sourceLocationId: 'W001',                                    reason: 'Cycle count — damaged unit',    createdAt: '2026-04-27T10:15:00Z', createdBy: 'Jane Doe' },
  { id: 'MV-2007', itemId: 'INV-1011', type: 'transfer',   quantity: 4,   sourceLocationId: 'W006', destinationLocationId: 'W001',     reason: 'Move to main stock',             createdAt: '2026-04-27T11:48:00Z', createdBy: 'Admin User' },
  { id: 'MV-2008', itemId: 'INV-1004', type: 'out',        quantity: 6,   sourceLocationId: 'W001',                                    reason: 'Cleaning crew — weekly',         createdAt: '2026-04-27T13:00:00Z', createdBy: 'John Smith' },
  { id: 'MV-2009', itemId: 'INV-1007', type: 'in',         quantity: 24,  destinationLocationId: 'W002',                              reason: 'PO-2025-0021 received',          createdAt: '2026-04-27T14:25:00Z', createdBy: 'Admin User' },
]
