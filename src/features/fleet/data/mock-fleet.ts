...
export const mockVehicles: Vehicle[] = [
  { id: 'V001', plateNumber: 'SGX 5482 K', model: 'Toyota Hilux',           year: 2025, status: 'active',      fuelType: 'diesel',   currentOdometer: 18420, fuelCapacityLiters: 80, assignedDriverId: 'DRV-003',                            checklistId: 'TPL-002', nextServiceDate: '2026-05-18', photoUrl: 'https://images.unsplash.com/photo-1559416523-140ddc3d238c?w=400&q=80', vendor: 'Toyota Philippines', purchaseDate: '2025-01-10', purchaseCost: 38500, warrantyExpiry: '2030-01-10', usefulLifeMonths: 96, salvageValue: 8000, description: 'Field operations vehicle — assigned to Site Alpha', createdAt: '2025-01-10' },
  { id: 'V002', plateNumber: 'SDM 7791 H', model: 'Ford Transit Van',       year: 2024, status: 'maintenance', fuelType: 'diesel',   currentOdometer: 64810, fuelCapacityLiters: 80,                                                                                       checklistId: 'TPL-002', nextServiceDate: '2026-05-04', photoUrl: 'https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=400&q=80', vendor: 'Ford',               purchaseDate: '2024-06-04', purchaseCost: 41200, warrantyExpiry: '2029-06-04', usefulLifeMonths: 96, salvageValue: 9000, description: 'Out for transmission service',                       createdAt: '2024-06-04' },
