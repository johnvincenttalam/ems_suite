...
export const mockVehicles: Vehicle[] = [
  { id: 'V001', plateNumber: 'SGX 5482 K', model: 'Toyota Hilux',           year: 2025, status: 'active',      fuelType: 'diesel',   currentOdometer: 18420, fuelCapacityLiters: 80, assignedDriverId: 'DRV-003', linkedAssetId: 'AST-008', checklistId: 'TPL-002', nextServiceDate: '2026-05-18', createdAt: '2025-01-10' },
  ...
  { id: 'V003', plateNumber: 'SBN 1184 J', model: 'Hyundai Staria 11-seat', year: 2023, status: 'active',      fuelType: 'diesel',   currentOdometer: 92140, fuelCapacityLiters: 75, assignedDriverId: 'DRV-002',                                  checklistId: 'TPL-002', nextServiceDate: '2026-05-29', createdAt: '2023-08-12' },
