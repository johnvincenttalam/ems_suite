...
const featurePages: Record<FeatureKey, ComponentType> = {
  ...
  tracking:            lazy(() => featureImports.tracking().then((m: any) => ({ default: m.MapPage }))),
  trackingGps:         lazy(() => featureImports.trackingGps().then((m: any) => ({ default: m.GpsPage }))),
  trackingTags:        lazy(() => featureImports.trackingTags().then((m: any) => ({ default: m.TagsPage }))),
  trackingScans:       lazy(() => featureImports.trackingScans().then((m: any) => ({ default: m.ScansPage }))),
